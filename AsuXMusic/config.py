...
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "KALAM_KRANTI")
OWNER_ID = list(map(int, getenv("OWNER_ID", "1236703127").split()))
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "1236703127").split()))
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "10000000000000000000000000000000"))

IMG_1 = getenv("IMG_1", "https://graph.org/file/44ace20a57659faf59243.jpg")
